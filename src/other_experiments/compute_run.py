...
import csv
from hpo_bo import optimize_hyperparameters
...
class Learner:
    ...
    def parse_command_line(self):
        ...
        # LiRA options
        parser.add_argument("--num_shadow_models", type=int, default=0,
    ...
    def run(self):
        ...
        for dataset in datasets:
            ...
            if self.args.type_of_tuning == 0:
                ...
                if self.args.use_specified_hypers == False:
    ...
    def train_test(
        ...
        # tuning each shadow model ONLY for TD setting AND if NO hypers are specified
        if self.args.type_of_tuning == 0 and self.args.use_specified_hypers == False:
